module elm_varpar
  ...
  integer            :: nh3dc_per_lunit=1     ! number of soil columns in landunit for h3d (set from nmaxhillcol dim)
  integer            :: nnode_per_nh3dc=1     ! number of lateral nodes in h3dc for solving hsb (must equal nh3dc_per_lunit)
